...
function getParticleSystem_smoke(params) {
  ...
  // numero "medio" di particelle vive = rate * maxLife, con un margine di sicurezza
  ...
  colorSpline.addPoint(1.0, new THREE.Color(0x000001));
...
export { getParticleSystem_smoke };
